...
void JetPlottingMergedFractionsEightPlot()
{
    ...
    {
        // Read histograms
        hDetECAL[Rvalue] = (TH1F *)(fin->Get(Form("hDetECAL_R%d", Rvalue))->Clone());
        NormalizeToProb(hDetECAL[Rvalue]);
        hDetECAL[Rvalue]->GetYaxis()->SetRangeUser(limitYpTmin, limitYpT);
        hPartNeutralMatch[Rvalue] = (TH1F *)(fin->Get(Form("hPartNeutralMatch_R%d", Rvalue))->Clone());
        NormalizeToProb(hPartNeutralMatch[Rvalue]);
        hPartNeutralMatch[Rvalue]->GetYaxis()->SetRangeUser(limitYpTmin, limitYpT);
        hDetECALAll[Rvalue] = (TH1F *)(fin->Get(Form("hDetECALAll_R%d", Rvalue))->Clone());
        NormalizeToProb(hDetECALAll[Rvalue]);
        hDetECALAll[Rvalue]->GetYaxis()->SetRangeUser(limitYpTmin, limitYpT);
        hPartNeutral[Rvalue] = (TH1F *)(fin->Get(Form("hPartNeutral_R%d", Rvalue))->Clone());
        NormalizeToProb(hPartNeutral[Rvalue]);
        hPartNeutral[Rvalue]->GetYaxis()->SetRangeUser(limitYpTmin, limitYpT);

        for (int ieta = 0; ieta < nEtaBins - 1; ++ieta)
        {
            hDetECALEta[Rvalue][ieta] = (TH1F *)(fin->Get(Form("hDetECALEta_%d_R%d", ieta, Rvalue))->Clone());
            NormalizeToProb(hDetECALEta[Rvalue][ieta]);
            hDetECALEta[Rvalue][ieta]->GetYaxis()->SetRangeUser(limitYEtamin, limitYEta);
            hPartNeutralMatchEta[Rvalue][ieta] = (TH1F *)(fin->Get(Form("hPartNeutralMatchEta_%d_R%d", ieta, Rvalue))->Clone());
            NormalizeToProb(hPartNeutralMatchEta[Rvalue][ieta]);
            hPartNeutralMatchEta[Rvalue][ieta]->GetYaxis()->SetRangeUser(limitYEtamin, limitYEta);
            hDetECALAllEta[Rvalue][ieta] = (TH1F *)(fin->Get(Form("hDetECALAllEta_%d_R%d", ieta, Rvalue))->Clone());
            NormalizeToProb(hDetECALAllEta[Rvalue][ieta]);
            hDetECALAllEta[Rvalue][ieta]->GetYaxis()->SetRangeUser(limitYEtamin, limitYEta);
            hPartNeutralEta[Rvalue][ieta] = (TH1F *)(fin->Get(Form("hPartNeutralEta_%d_R%d", ieta, Rvalue))->Clone());
            NormalizeToProb(hPartNeutralEta[Rvalue][ieta]);
            hPartNeutralEta[Rvalue][ieta]->GetYaxis()->SetRangeUser(limitYEtamin, limitYEta);

            for (int iconst = 0; iconst < nConst; ++iconst)
            {
                hDetECALEtaConst[Rvalue][ieta][iconst] = (TH1F *)(fin->Get(Form("hDetECALEta_%d_Const_%d_R%d", ieta, iconst, Rvalue))->Clone());
                NormalizeToProb(hDetECALEtaConst[Rvalue][ieta][iconst]);
                hDetECALEtaConst[Rvalue][ieta][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
                hPartNeutralMatchEtaConst[Rvalue][ieta][iconst] = (TH1F *)(fin->Get(Form("hPartNeutralMatchEta_%d_Const_%d_R%d", ieta, iconst, Rvalue))->Clone());
                NormalizeToProb(hPartNeutralMatchEtaConst[Rvalue][ieta][iconst]);
                hPartNeutralMatchEtaConst[Rvalue][ieta][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
                hDetECALAllEtaConst[Rvalue][ieta][iconst] = (TH1F *)(fin->Get(Form("hDetECALAllEta_%d_Const_%d_R%d", ieta, iconst, Rvalue))->Clone());
                NormalizeToProb(hDetECALAllEtaConst[Rvalue][ieta][iconst]);
                hDetECALAllEtaConst[Rvalue][ieta][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
                hPartNeutralEtaConst[Rvalue][ieta][iconst] = (TH1F *)(fin->Get(Form("hPartNeutralEta_%d_Const_%d_R%d", ieta, iconst, Rvalue))->Clone());
                NormalizeToProb(hPartNeutralEtaConst[Rvalue][ieta][iconst]);
                hPartNeutralEtaConst[Rvalue][ieta][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
            }
        }
        for (int iconst = 0; iconst < nConst; ++iconst)
        {
            hDetECALConst[Rvalue][iconst] = (TH1F *)(fin->Get(Form("hDetECALConst_%d_R%d", iconst, Rvalue))->Clone());
            NormalizeToProb(hDetECALConst[Rvalue][iconst]);
            hDetECALConst[Rvalue][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
            hPartNeutralMatchConst[Rvalue][iconst] = (TH1F *)(fin->Get(Form("hPartNeutralMatchConst_%d_R%d", iconst, Rvalue))->Clone());
            NormalizeToProb(hPartNeutralMatchConst[Rvalue][iconst]);
            hPartNeutralMatchConst[Rvalue][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
            hDetECALAllConst[Rvalue][iconst] = (TH1F *)(fin->Get(Form("hDetECALAllConst_%d_R%d", iconst, Rvalue))->Clone());
            NormalizeToProb(hDetECALAllConst[Rvalue][iconst]);
            hDetECALAllConst[Rvalue][iconst]->GetYaxis()->SetRangeUser(limitYconstmin, limitYconst);
            hPartNeutralConst[Rvalue][iconst] = (TH1F *)(fin->Get(Form("hPartNeutralConst_%d_R%d", iconst, Rvalue))->Clone());
            NormalizeToProb(hPartNeutralConst[Rvalue][iconst]);
    ...
    for (int Rvalue = 0; Rvalue < nR; Rvalue++)
    {
        ...
        TLegend *legendPartNeutralEta = new TLegend(0.65, 0.7, 0.85, 0.85);
        legendPartNeutralEta->SetBorderSize(0);
        for (int ieta = 0; ieta < nEtaBins - 1; ++ieta)
        {
            ...
            cDetECALEta->cd();
            if (ieta == 0)
                hDetECALEta[Rvalue][ieta]->Draw();
            else
                hDetECALEta[Rvalue][ieta]->Draw("same");
            ...
            if (ieta == 0)
                hPartNeutralMatchEta[Rvalue][ieta]->Draw();
            else
                hPartNeutralMatchEta[Rvalue][ieta]->Draw("same");
            ...
            cPartNeutralEta->cd();
            if (ieta == 0)
                hPartNeutralEta[Rvalue][ieta]->Draw();
            else
                hPartNeutralEta[Rvalue][ieta]->Draw("same");
            ...
            for (int iconst = 0; iconst < nConst; ++iconst)
            {
                ...
                hDetECALEtaConst[Rvalue][ieta][iconst]->SetMarkerColor(gcolors[iconst]);
                ...
                hPartNeutralMatchEtaConst[Rvalue][ieta][iconst]->SetMarkerColor(gcolors[iconst]);
                ...
                cDetECALEtaConst->cd();
                if (ieta == 0)
                    hDetECALEtaConst[Rvalue][ieta][iconst]->Draw();
                else
                    hDetECALEtaConst[Rvalue][ieta][iconst]->Draw("same");
                ...
                if (ieta == 0)
                    hPartNeutralMatchEtaConst[Rvalue][ieta][iconst]->Draw();
                else
                    hPartNeutralMatchEtaConst[Rvalue][ieta][iconst]->Draw("same");
            ...
            cDetECALEtaConst->SaveAs(Form("figs/FRAC_NoNorm/cDetECALEta_%dConst_R%d.png", ieta, Rvalue));
            ...
            cPartNeutralMatchEtaConst->SaveAs(Form("figs/FRAC_NoNorm/cPartNeutralMatchEta_%dConst_R%d.png", ieta, Rvalue));
        }
        ChangeTitleOfCanvas(cDetECALEta, Form("Matched detector level jet ECAL energy fraction, R=%0.1f", Rvals[Rvalue]));
        cDetECALEta->SaveAs(Form("figs/FRAC_NoNorm/cDetECALEta_R%d.png", Rvalue));
        ChangeTitleOfCanvas(cPartNeutralMatchEta, Form("Matched particle level jet neutral energy fraction, R=%0.1f", Rvals[Rvalue]));
        cPartNeutralMatchEta->SaveAs(Form("figs/FRAC_NoNorm/cPartNeutralMatchEta_R%d.png", Rvalue));
        ChangeTitleOfCanvas(cPartNeutralEta, Form("Total particle level jet neutral energy fraction, R=%0.1f", Rvals[Rvalue]));
        cPartNeutralEta->SaveAs(Form("figs/FRAC_NoNorm/cPartNeutralEta_R%d.png", Rvalue));
        /*
                ...
                cDetECALConst->SaveAs(Form("figs/FRAC_NoNorm/cDetECALConst_R%d.png", Rvalue));
                ChangeTitleOfCanvas(cPartNeutralMatchConst, Form("Matched particle level jet neutral energy fraction, R=%0.1f", Rvals[Rvalue]));
                cPartNeutralMatchConst->SaveAs(Form("figs/FRAC_NoNorm/cPartNeutralMatchConst_R%d.png", Rvalue));
