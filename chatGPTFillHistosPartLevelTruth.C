...
void chatGPTFillHistosPartLevelTruth(Int_t NormValue = 0) { //truth particle level jets
    ...
    if(NormValue==0)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_5-10GeV_Merged_Output.root", "RECREATE");
    if(NormValue==1)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_10-20GeV_Merged_Output.root", "RECREATE");
    if(NormValue==2)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_20-30GeV_Merged_Output.root", "RECREATE");
    if(NormValue==3)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_30-40GeV_Merged_Output.root", "RECREATE");
    if(NormValue==4)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_40-60GeV_Merged_Output.root", "RECREATE");
    if(NormValue==5)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_60-100GeV_Merged_Output.root", "RECREATE");
    if(NormValue==6)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_100-200GeV_Merged_Output.root", "RECREATE");
    if(NormValue==7)fout = new TFile("JetJetOutput/July2023/data/ptmin10/truth_20230722_pythia8_JetJet_200-GeV_Merged_Output.root", "RECREATE");
