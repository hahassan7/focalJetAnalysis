...
void focalJetResolutions( 
    ...
    for (Int_t r = 0; r < RMax; r++){
      ...
      SetStyleHistoTH2ForGraphs(esframeR, "#Delta#it{p}_{T} = (#it{p}_{T,det}-#it{p}_{T,part})/#it{p}_{T,part} ","1/#it{k} d#it{N}/d#Delta#it{p}_{T}", 0.85*textSizeLabels[0],textSizeLabels[0], 0.85*textSizeLabels[0],textSizeLabels[0], 0.955, 1.45, 510, yDivs, 42, 62);
      ...
      padMiddle->cd();
        ...
        SetStyleHistoTH2ForGraphs(esframeM, "#Delta#it{p}_{T} = (#it{p}_{T,det}-#it{p}_{T,part})/#it{p}_{T,part} ","1/k d#it{N}/d#Delta#it{p}_{T}", 0.85*textSizeLabels[1],textSizeLabels[1], 0.85*textSizeLabels[1],textSizeLabels[1], 0.84, 0.95,  510, yDivs, 42, 62);
      ...
      padLeft->cd();
        ...
        SetStyleHistoTH2ForGraphs(esframeL, "#Delta#it{p}_{T} = (#it{p}_{T,det}-#it{p}_{T,part})/#it{p}_{T,part} ","#it{p}", 0.85*textSizeLabels[1],textSizeLabels[1], 0.85*textSizeLabels[1],textSizeLabels[1], 0.83, 0.95,  510, yDivs, 42, 62);
