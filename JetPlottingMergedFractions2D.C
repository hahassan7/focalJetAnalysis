...
{   
    ...
    //if(NormValue==0)jetFile = TFile::Open("/home/lmh/alice/fromPuhti/July2023/data/20230722_pythia8_JetJet_5-10GeV/Merged.root");
    ...
    if(NormValue==0)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_5-10GeV_Merged_Output.root", "RECREATE");
    if(NormValue==1)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_10-20GeV_Merged_Output.root", "RECREATE");
    if(NormValue==2)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_20-30GeV_Merged_Output.root", "RECREATE");
    if(NormValue==3)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_30-40GeV_Merged_Output.root", "RECREATE");
    if(NormValue==4)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_40-60GeV_Merged_Output.root", "RECREATE");
    if(NormValue==5)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_60-100GeV_Merged_Output.root", "RECREATE");
    if(NormValue==6)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_100-200GeV_Merged_Output.root", "RECREATE");
    if(NormValue==7)fout = new TFile("JetJetOutput/July2023/ptmin10/fractions/2D/2D_20230722_pythia8_JetJet_200-GeV_Merged_Output.root", "RECREATE");
    ...
    //histograms
        hRespMatrix[Rvalue] = new TH2F(Form("hRespMatrix_R%d", Rvalue), Form("Detector ECAL fraction vs Particle neutral energy fraction, R=%0.1f;#it{E}_{ECAL}/#it{E}_{jet}^{det} (GeV);#it{E}_{neutral}/#it{E}_{jet}^{part}", Rvals[Rvalue]), 21, -0.025, 1.025, 21, -0.025, 1.025); 
        ...
        //hRespMatrix[Rvalue]->Scale(1./hRespMatrix_E->Integral(), "width"); //only perform this normalization at final stage of plotting

        for (int iE = 0; iE < nEBins-1; ++iE) 
        {
            hRespMatrixE[Rvalue][iE] = new TH2F(Form("hRespMatrixE%d_R%d", iE, Rvalue), Form("Detector ECAL fraction vs Particle neutral energy fraction, E_{jet}^{det}: %d - %d GeV, R=%0.1f;#it{E}_{ECAL}/#it{E}_{jet}^{det} (GeV);#it{E}_{neutral}/#it{E}_{jet}^{part}", int(JetEBorders[iE]), int(JetEBorders[iE+1]), Rvals[Rvalue]), 21, -0.025, 1.025, 21, -0.025, 1.025); 
        ...
        {
            hRespMatrixpT[Rvalue][ipT] = new TH2F(Form("hRespMatrixpT%d_R%d", ipT, Rvalue), Form("Detector ECAL fraction vs Particle neutral energy fraction, pT_{jet}^{det}: %d - %d GeV, R=%0.1f;#it{E}_{ECAL}/#it{E}_{jet}^{det} (GeV);#it{E}_{neutral}/#it{E}_{jet}^{part}", int(JetpTBorders[ipT]), int(JetpTBorders[ipT+1]), Rvals[Rvalue]), 21, -0.025, 1.025, 21, -0.025, 1.025); 
